  ...
  return (
    <div className=" w-full">
      ...
      <div className=" md:border-stone-950 justify-between  md:border-2 flex ">
        ...
        <div class=" hidden w-full md:block md:w-auto" id="navbar-default ">
          <ul class=" md:p-5 pt-3 items-center font-medium flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
