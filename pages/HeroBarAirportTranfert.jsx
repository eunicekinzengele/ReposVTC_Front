...
export default function HeroBarAirportTranfert() {
  return (
    <div className=" text-center pb-20">
      <div className=" bg-[url('../Images/HeroTransfertImg.jpg')] bg-no-repeat bg-center bg-cover object-contain relative w-full h-96 ">
